...
public class Checkout extends AppCompatActivity implements PaytmPaymentTransactionCallback {
    ...
    public class sendUserDetailTOServerdd extends AsyncTask<ArrayList<String>, Void, String> {
        ...
        protected String doInBackground(ArrayList<String>... alldata) {
            ...
            JSONParser jsonParser = new JSONParser(Checkout.this);
        ...
        protected void onPostExecute(String result) {
            ...
            Service.startPaymentTransaction(Checkout.this, true, true, Checkout.this  );
        }
    }
    @Override
